...
setup(
   ...
   install_requires=["pygments","Pillow","psycopg2","python-social-auth","django",",simplejson","python-creole", "djangorestframework", "django-filter", "beautifulsoup4","sh", "pathlib", "loremipsum"],
