...
extensions = ['sphinx.ext.napoleon','sphinx.ext.viewcode', 'sphinx.ext.autosectionlabel']
...
project = u'MyCMS'
copyright = u'2018, Jason Viloria'
...
man_pages = [
    ('index', 'mycms', u'MyCMS Documentation',
     [u'MyCMS'], 1)
]
