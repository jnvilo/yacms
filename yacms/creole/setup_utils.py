...
"""
    ...
    try:
        from yacms.creole.setup_utils import get_long_description
    except ImportError:
...
from yacms.creole import creole2html, html2rest
from yacms.creole.shared.unknown_tags import raise_unknown_node, transparent_unknown_nodes
from yacms.creole.py3compat import PY3
...
def get_long_description(package_root, filename="README.creole", raise_errors=None):
    ...
    try:
        ...
        if raise_errors:
            ...
            from yacms.creole.rest2html.pypi_rest2html import pypi_rest2html
            try:
