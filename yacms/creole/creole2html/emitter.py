...
from yacms.creole.creole2html.parser import CreoleParser
from yacms.creole.py3compat import TEXT_TYPE, repr2
from yacms.creole.shared.utils import string2dict
...
class TableOfContent(object):
    ...
    def emit(self, document):
        ...
        """
        In order to make it easier to selectively style the created toc, we sorround
        the ul with a div to be able to style the toc independently.
        
        This allows us to style the menu. 
        """
...
"""
    ...
    print("-" * 80)
#    from yacms.creole_alt.creole import CreoleParser
    p = CreoleParser(txt)
    document = p.parse()
    p.debug()
