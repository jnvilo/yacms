...
setup(
   ...
   install_requires=["pygments","Pillow","python-social-auth","arrow","django","simplejson","python-creole", "djangorestframework", "django-filter", "beautifulsoup4","sh", "pathlib", "loremipsum"],
